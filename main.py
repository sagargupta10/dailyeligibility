# -*- coding: utf-8 -*-
# sgsen@jumbotail.com, puja@jumbotail.com, sagar.gupta@jumbotail.com
...
cheque_data=jtdf.get_jtchequedata(custList,googlesecretkey_location,rs_user_id,rs_password)

#%%
print("Fetching credit data")
credit_data=jtdf.get_creditdata(custList,googlesecretkey_location,rs_user_id,rs_password)
